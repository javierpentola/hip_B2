...
<main class="main-content">
    <div class="system-settings-section">
        ...
        <form class="settings-form">
            ...
            <button type="submit" class="action-btn">Guardar Ajustes</button>
        </form>

        <h3>Plantillas de Email</h3>
        <div class="email-template">
            <h4>Confirmación de Factura</h4>
            <textarea id="invoiceConfirmationTemplate">
Estimado {clientName},

Le confirmamos que hemos recibido su pago por la factura #{invoiceNumber}.
...
HIP ENERGY
            ...
            <button class="action-btn" onclick="saveEmailTemplate('invoiceConfirmation')">Guardar Plantilla</button>
        </div>
        <div class="email-template">
            <h4>Notificación de Lectura de Factura</h4>
            <textarea id="invoiceReadTemplate">
Estimado administrador,

El cliente {clientName} ha leído la factura #{invoiceNumber}.

Detalles:
- Fecha de lectura: {readDate}
- Monto de la factura: {amount} {currency}
...
HIP ENERGY
            ...
            <button class="action-btn" onclick="saveEmailTemplate('invoiceRead')">Guardar Plantilla</button>
        </div>
    </div>
</main>
...
<script>
    function saveEmailTemplate(templateType) {
        const template = document.getElementById(`${templateType}Template`).value;
        // Implementar lógica para guardar la plantilla
        alert(`Plantilla de ${templateType} guardada.`);
    }
